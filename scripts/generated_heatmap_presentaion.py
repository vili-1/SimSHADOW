...
def main():
    ...
    for ftype, stats in mean_std.items():
        if (debug):
            ...
            print(stats["std"])
        plot_results(stats["mean"],ftype+": MEAN",abs_mean_max*1.02,-abs_mean_max*1.02,'coolwarm')
        plot_results(stats["std"],ftype+": STDV",abs_std_max*1.2,-abs_std_max*1.2,"PiYG")
